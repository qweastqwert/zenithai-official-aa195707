...
const ResourceCard: React.FC<ResourceCardProps> = ({ resource }) => {
  return (
    ...
    >
      <Card className="bg-card border-border hover:shadow-lg hover:border-primary/40 transition-all duration-200 overflow-hidden h-full cursor-pointer">
        {/* Image */}
        ...
        <CardContent className="p-3 sm:p-4">
          ...
          {/* Title */}
          <h3 className="font-semibold text-foreground mb-1.5 line-clamp-2 text-sm sm:text-base leading-snug group-hover:text-primary transition-colors">
            {resource.title}
          </h3>
          ...
          <div className="flex justify-between items-center pt-2 border-t border-border/50">
            <span className="inline-flex items-center gap-1 text-xs sm:text-sm text-primary font-medium">
              Read article
