          ...
          <AnimatePresence>
            {allItems.map((item, idx) => {
              ...
              return (
                ...
                >
                  {!isRecurring && editingId === event.id ? (
                    <div className="flex-1 space-y-2">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        ...
                        <Input type="time" value={editEnd} onChange={(e) => setEditEnd(e.target.value)} className="h-8 text-xs" disabled={isAutoGenerated} />
                      </div>
                      {isAutoGenerated && (
                        <p className="text-[10px] text-muted-foreground italic">
                          Editing time updates your sleep schedule everywhere ✨
                        </p>
                      )}
                      <div className="flex justify-end gap-1">
                        ...
                        <Button size="sm" className="h-7 px-2 bg-primary hover:bg-primary/90" onClick={() => saveEdit(event as ScheduleEvent)}>
                      ...
                      <div className="flex items-center gap-1 flex-shrink-0">
                        ...
                        {!isRecurring && onEdit && (
                          <Button
                            ...
                            onClick={() => startEdit(event as ScheduleEvent)}
                            title={isAutoGenerated ? 'Edit sleep/wake time' : 'Edit event'}
                          >
