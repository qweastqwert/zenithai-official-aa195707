        ...
        >
          {features.map((feature) => (
            <motion.div key={feature.title} variants={staggerItem}>
              <Card className="group border-none bg-card/80 backdrop-blur-sm hover:bg-card shadow-sm hover:shadow-xl transition-all duration-500 overflow-hidden h-full">
