...
import { Loader2, Shield, Users, FileCheck, BarChart3 } from 'lucide-react';
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="p-4 bg-muted/50 rounded-lg">
                  <h3 className="font-semibold mb-2">🔒 Secure Admin Features</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    This section is protected by database-level RLS policies. Only verified admins can access these controls.
                  </p>
                  <ul className="text-sm space-y-2 text-muted-foreground">
                    <li>• Role assignment verified through security definer function</li>
                    <li>• All admin actions logged and auditable</li>
                    <li>• User role changes require database-level permissions</li>
                  </ul>
                </div>
              </CardContent>
            </Card>
